						...
						<div class="col-md-10">
							...
							<div class="row row-cols">
								...
								<div class="col-md-4 col-get-in-touch">
									...
									<h4 class="hidden-xs">Contatos</h4>
									...
									<div class="row-fluid visible-xs">
										<div class="col-xs-6">
											<a href="#" class="btn btn-footer "><i class="fa fa-map-marker"></i>Local</a>
										</div>
										<div class="col-xs-6">
											<a href="#" class="btn btn-footer"><i class="fa fa-phone"></i>Telefone</a>
										</div>
									</div>
